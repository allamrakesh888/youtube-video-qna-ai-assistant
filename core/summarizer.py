...
def generate_summary(transcript : str) -> str:
    ...
    combined_prompt = ChatPromptTemplate.from_messages(
        ...
        (
            "system",
            "You are an expert youtube audio summarizer. Combine these partial summaries "
...
def generate_title(transcipt : str) -> str:
    ...
    title_chain = (
        ...
        ChatPromptTemplate.from_messages([
             (
                "system",
                "Based on the youtube video transcript, generate a short professional video title "
